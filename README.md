...
- [Cadastro de Alunos](https://github.com/romariomorais01/Cadastro-de-alunos-em-Python)  
...
- [Identificador de Polígonos](https://github.com/romariomorais01/Identificando-poligonos-pelo-numero-de-lados)  
...
- [Identificador de Gadgets](https://github.com/romariomorais01/Identificando-Gadget-em-java)  
  Classifica dispositivos com base em características fornecidas.  
  **Como executar:** compile com `javac` e execute com `java Main`.
